...
//the layer to query in order to get BBOX (no bbox param defined in URL)
...
//we distinguish raster and vectorial data (raster must be the first one in the GetMap URL that creates the image)
...
$edit_url="http://edit.csic.es/geoserver/wms?SERVICE=WMS&VERSION=1.1.1&REQUEST=GetMap&SERVICE=WMS&EPSG=4326&layers=";
...
$edit_url.=",topp:rest_points&format=image/png&bbox=".$bbox."&WIDTH=".$width."&HEIGHT=".$height."&SLD=http://edit.csic.es/fitxers/sld/point_".$random.".sld";

$image=imagecreatefrompng($edit_url);
$legend_url="http://edit.csic.es/geoserver/wms/GetLegendGraphic?SERVICE=WMS&VERSION=1.1.1&format=image/png&WIDTH=30&HEIGHT=45&layer=topp:rest_points&SLD=http://edit.csic.es/fitxers/sld/point_".$random.".sld";
$l_image=imagecreatefrompng($legend_url);
imagecopymerge($image,$l_image,0,($height/2),0,0,190,130,100);
