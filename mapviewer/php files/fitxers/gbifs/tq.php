...
$url = "http://data.gbif.org/species/classificationSearch?view=json&allowUnconfirmed=false&providerId=2&query=".urlencode($_REQUEST["t"]);
$ch = curl_init();
...
$count=0;
//$output="<div id='data'>";
$output="<script type='text/javascript' src='http://edit.csic.es/edit_geo/prototype/js_code/jquery.js'></script><script></script>";
$currentLevel="";
$taxonTree="";
