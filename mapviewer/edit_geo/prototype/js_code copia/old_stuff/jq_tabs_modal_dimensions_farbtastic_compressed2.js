...
$("#informacio").hide();
   ...
   $("#close_txt").click(function(){$('#ex2').hide()});
...
//var sld=
//SizeNode=sld.selectSingleNode(""+xpath+"").firstChild;
...
//console.dirxml(config.objects.mainMap.doc);
...
var jq='<div class="jqmdTL" style="background-size: 40%; z-index: 300;"><div class="jqmdTR"><div class="jqmdTC jqDrag">'+text+'<a id="close_txt" style="float:right">close it</a></div><input type="image" src="JQ_win_files/close.gif" class="jqmdX jqmClose" /></div><input type="image" src="JQ_win_files/close.gif" class="jqmdX jqmClose" /></div></div>';
