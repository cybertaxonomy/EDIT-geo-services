...
//	$("#format_form").submit(function() 
	...
	edit_raster:edit_raster.join('/'),edit_sld:edit_sld,edit_vectorial:edit_vectorial,legend:legend,format:"png/gray",bbox:bbox,remote_layers:remote_layers.join('|')},function(url_image){bindFrameActions();$("iframe#info").attr("src",url_image);$("#ex_print").show();return false;});  
													}
																	break;
								case 'jpeg/gray': 					
								{
