 ...
 $(document).ready(function() {
	$("#format_form,#download_data").show();
		   $("#download_data").one('click',function()
	        {
	     $.getScript('js_code/edit_no_sld/print.js');
	        } );
...
//   console.log ($.browser.version);
  ...
  //     } //else {};
	...
	//	mainMap="http://edit.csic.es/edit_geo/prototype/XMLs/world2.xml";
...
//	console.log("ready");
		...
		//alert("only Firefox 2.0!");} ;
  $("#demo,.sld_info").hide();
//user_dates només hi serà quan estiguem en el context Iberia
	$("#user_dates").one('click',function()
	{
	//	alert(extent);
...
//alert(extent);
 ...
 $('#query_result,#ex2,#ex3,#ex_info,.tabs,div[@id*="_lay"],#help,dd:not(:first),#workspace').hide();
   ...
   if(selected) {
	...
	//	alert("first use");
				$("#id").addClass("selected");
			       $.getScript('js_code/edit_no_sld/symbology.js');      
