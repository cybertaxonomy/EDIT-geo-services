...
<xsl:if test="not($grup='climate' or $grup='utm' or $grup='topography' or $grup='Administrative' or $grup='landcover' or $grup='puntos' or $grup='utm2500analysis' or $grup='enviranalysis')">
