          ...
          <PointSymbolizer>
            <Graphic>
              <Mark>
                ...
                <Fill>
                  <CssParameter name="fill">
                    <ogc:Literal>#eb6e5c</ogc:Literal>
                  </CssParameter>
                  <CssParameter name="fill-opacity">0.9</CssParameter>
                </Fill>
                <Stroke>
          ...
          <PointSymbolizer>
            <Graphic>
              <Mark>
                ...
                <Fill>
                  <CssParameter name="fill">
                    <ogc:Literal>#64e548</ogc:Literal>
                  </CssParameter>
                  <CssParameter name="fill-opacity">0.9</CssParameter>
                </Fill>
                <Stroke>
          ...
          <PointSymbolizer>
            <Graphic>
              <Mark>
                ...
                <Fill>
                  <CssParameter name="fill">
                    <ogc:Literal>#f01f14</ogc:Literal>
                  </CssParameter>
                  <CssParameter name="fill-opacity">0.9</CssParameter>
                </Fill>
                <Stroke>
          ...
          <PointSymbolizer>
            <Graphic>
              <Mark>
                ...
                <Fill>
                  <CssParameter name="fill">
                    <ogc:Literal>#ed9931</ogc:Literal>
                  </CssParameter>
                  <CssParameter name="fill-opacity">0.9</CssParameter>
                </Fill>
                <Stroke>
          ...
          <PointSymbolizer>
            <Graphic>
              <Mark>
                ...
                <Fill>
                  <CssParameter name="fill">
                    <ogc:Literal>#d21bee</ogc:Literal>
                  </CssParameter>
                  <CssParameter name="fill-opacity">0.9</CssParameter>
                </Fill>
                <Stroke>
