    ...
    <UserStyle>
      <FeatureTypeStyle>
        <Rule>
          ...
          <TextSymbolizer>
            <ogc:Label>Area of Portugal</ogc:Label>
            <Font>
          ...
          <PolygonSymbolizer>
            ...
            <Stroke>
              <CssParameter name="stroke">#252ab6</CssParameter>
              <CssParameter name="stroke-width">1</CssParameter>
              <CssParameter name="stroke-opacity">1</CssParameter>
              <CssParameter name="stroke-dasharray">2 3 2 3</CssParameter>
            </Stroke>
          </PolygonSymbolizer>
        </Rule>
        <Rule>
          ...
          <TextSymbolizer>
            <ogc:Label>Region of Importance</ogc:Label>
            <Font>
              <CssParameter name="font-style">Normal</CssParameter>
              <CssParameter name="font-size">10</CssParameter>
              <CssParameter name="font-weight">bold</CssParameter>
          ...
          <PolygonSymbolizer>
            ...
            <Stroke>
              ...
              <CssParameter name="stroke-dasharray">10 30 10 30</CssParameter>
            </Stroke>
          </PolygonSymbolizer>
        </Rule>
      </FeatureTypeStyle>
