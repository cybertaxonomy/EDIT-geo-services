...
$("iframe#info").attr('src','http://taxonomicindex.africamuseum.be/edit_wp5/geo/formularis/select_by_genus.html?userid='+userid+"&p="+third+"_"+fourth);
												...
												//					console.log(g)
																...
																//	console.log(g_name)		
																	...
																	$.ajax({url:'http://taxonomicindex.africamuseum.be/edit_wp5/geo/test_xmls2.php',
																			...
																			//		edit_points.redraw();
																			//g_legend.setAttribute("src",legend='http://193.190.223.53:8080/geoserver/wms/GetLegendGraphic?VERSION=1.0.0&FORMAT=image/png&WIDTH=25&HEIGHT=20&LAYER=topp:test_csvimportgispoints2&sld='+edit_points.params.SLD+'?date='+new Date());
																/*				Size=[];
