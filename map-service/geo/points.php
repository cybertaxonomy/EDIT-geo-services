...
//$path_towrite=DIR_PLATFORM."/synthesys/www/fitxers/sld/point_".$random.".sld";
$path_towrite=SLD_DIR3."/point_".$random.".sld";
print($path_towrite);
...
$edit_url.=",topp:rest_points&format=image/png&bbox=".$bbox."&WIDTH=".$width."&HEIGHT=".$height."&".SLD_URL3"./point_".$random.".sld";
...
$wd=22;//*$count;
$h=10;//*$count;
//$legend_url=URL_GEOSERVER."/GetLegendGraphic?SERVICE=WMS&VERSION=1.1.1&format=image/png&WIDTH=$wd&HEIGHT=$h&layer=topp:rest_points&SLD=".URL_SITE."/edit_wp5/fitxers/sld/point_".$random.".sld";
//echo $legend_url;
