...
$('#gbif_win').jqm({
    ...
    var jq='<div class="jqmdTL" style="background-size: 40%; z-index: 300;"><div class="jqmdTR"><div class="jqmdTC jqDrag">'+text+'</div><input type="image" class="jqmdX jqmClose"/><iframe id="geo_frame22" name="geo_frame22" class="jqDrag" marginWidth=0 marginHeight=0 src="http://edit.africamuseum.be/edit_wp5/geo/formularis/boxes_form.html?userid='+userid+'&p='+third+'_'+fourth+'" frameBorder=0 width=420 height=300; background-color=#D7DBDF"></iframe></div></div><div class="jqmdTR"><div class="jqmdTC jqDrag">'+text+'</div>';
...
var iframe=$('iframe#geo_frame22'); 

 $(iframe).bind('load', function()
{
    iframe=$("iframe#geo_frame22");
