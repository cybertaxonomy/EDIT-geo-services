...
$('#content').remove();
	 ...
	 $.get('http://edit.africamuseum.be/edit_wp5/geo/queries/polygon_query_sld_adaptat.php', {param: polygon,user:userid }, function(data) {$("#query_container").append(data); bindBehaviors(data);$("#repaginate2").show()});
