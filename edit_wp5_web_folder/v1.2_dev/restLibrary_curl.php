...
//class doing the HTTP POST conenction via cURL.
//3rd and 4th parameters of the contructor  are optional (define them only if proxy')

 /**
 * code based on "A sample class to read HTTP headers"
 * @author Geoffray Warnants - http://www.geoffray.be (lines added by F Theeten for POST and Proxt connection)
 */
...
//code doing the conenction and returning the result
