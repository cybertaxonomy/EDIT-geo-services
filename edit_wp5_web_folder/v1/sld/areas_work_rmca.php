...
$leg=$_GET['legend'];
//$random2="/var/www/edit/synthesys/www/v1/cr_img/".(rand()%300).".png"; 
$random2="/var/www/edit/synthesys/www/v1/img/".md5($_SERVER["REQUEST_URI"] ).".png";

$sld_dir = "/var/www/edit/synthesys/www/v1/sld"; 
$img_dir = "/var/www/edit/synthesys/www/v1/img";
$d = dir($sld_dir);
$e = dir($img_dir);
...
//$images_url="a,b:193.190.223.46:8080/fitxers/hatch_images|c:193.190.223.46:8080/fitxers/hatch_images";
...
//$random = (rand()%300).".sld";
//$leg_path_towrite="/var/www/edit/synthesys/www/fitxers/sld/$random";
$leg_path_towrite="/var/www/edit/synthesys/www/v1/sld/$random";
$fp=fopen("$leg_path_towrite","w");
$write=fwrite($fp,$out);
$leg_url="http://edit.africamuseum/synthesys/v1/sld/$random";
...
if ($_GET['bbox'])
	{
		$bbox=$_GET['bbox'];
			...
			//$conn = pg_connect("host=localhost port=5432 password=postgres user=postgres dbname=gbif3");
...
switch ($feature)
{
	case ('cr1'): $layer='topp:cr_adm1';$db_layer='cr_adm1';
	$field='code';$label_field='code';

	break;
	
	case ('cr2'): $layer='topp:cr_adm2';$db_layer='cr_adm2';
	$field='code';$label_field='code';
	break;
...
srand(time());
//$random = (rand()%300).".sld";
$path_towrite="/var/www/edit/synthesys/www/v1/sld/".$feature."_".$random;
//echo $path_towrite;
...
$url="http://193.190.223.46:8080/geoserver/wms?SERVICE=WMS&VERSION=1.1.1&REQUEST=GetMap&TRANSPARENT=TRUE&SERVICE=WMS&EPSG=4326&layers=";
...
$url.="&format=image/png&bbox=".$bbox."&WIDTH=".$width."&HEIGHT=".$height."&SLD=http://edit.africamuseum.be/synthesys/www/v1/sld/".$feature."_".$random;
...
$img=$_GET['img'];
$legend_url="http://193.190.223.46:8080/geoserver/wms/GetLegendGraphic?SERVICE=WMS&VERSION=1.1.1&format=image/png&TRANSPARENT=TRUE&WIDTH=64&HEIGHT=36&";
...
$t_position='0x0+10+'.$h;
$c="convert -pointsize $f_size -stroke $f_color $antialias -font '/var/www/edit/synthesys/Data_Directory/Fonts/$font' -annotate $t_position '$mc' $random2 $random2";
...
//readfile($random2);
$random3 ="/var/www/edit/synthesys/www/v1/img/".(rand()%300).".png";
//
//echo $legend_url;
if ($leg=='1')
{
