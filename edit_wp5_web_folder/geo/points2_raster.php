...
//$URL_WMS=URL_GEOSERVER;
//$URL_SLD=URL_SITE."/synthesys/www/fitxers/sld";
//$path_to_write=DIR_PLATFORM."/synthesys/www/fitxers/sld";
//$connection_string=POSTGIS_CS;
$URL_WMS=URL_GEOSERVER;
$URL_SLD=SLD_URL3;
$path_to_write=SLD_DIR3;
$connection_string=POSTGIS_CS;
...
//$r= DIR_PLATFORM."/edit_wp5/".(rand()%300).".png";
$r= DIR_PLATFORM."/".(rand()%300).".png";
