...
//    $("#color_form form ,#symbol_form form,#size_form form").empty(); 
   ...
   $("#ex2").animate({width:'380',height:'325'},"slow");
    ...
    edit_points.params.SLD="http://edit.africamuseum.be/edit_wp5/geo/sld/temp/"+userid+"/120dpi/"+userid+".sld";
$("iframe#info").attr('src','http://edit.africamuseum.be/edit_wp5/geo/formularis/select_by_genus.html?userid='+userid+'&p=pere_rock');


edit_points.redraw();
var image=document.getElementById("legend");
	image.setAttribute("src",legend='http://193.190.223.46:8080/geoserver//wms/GetLegendGraphic?VERSION=1.0.0&FORMAT=image/png&WIDTH=25&HEIGHT=20&LAYER=topp:test_csvimportgispoints2&sld='+edit_points.params.SLD);
$('div[id*="_form"]').hide();
$("#send").hide();
$("#informacio,#what_todo").hide();
...
//        $('div[id*="_form"]').hide();
	...
	if ($.browser.msie==true) { s=0; } else {s=1;};				
						...
						$.ajax({url:'http://edit.africamuseum.be/edit_wp5/geo/mapviewer/test_xmls2.php',
								...
								var image=document.getElementById("legend");
								image.setAttribute("src",legend='http://193.190.223.46:8080/geoserver/wms/GetLegendGraphic?VERSION=1.0.0&FORMAT=image/png&WIDTH=25&HEIGHT=20&LAYER=topp:test_csvimportgispoints2&SLD='+data);
								}});
		}
	}
}
