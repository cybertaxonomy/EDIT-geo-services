  $.get('http://taxonomicindex.africamuseum.be/edit_wp5/geo/modules/print_module.php',function(data)
{
	...
	////				'font-size':'10',
	          ...
	          .children().hide();
				 ...
				 var units=map.getUnits();
						...
						$.get('http://taxonomicindex.africamuseum.be/edit_wp5/geo/test_scalebar2.php',{g_units:g_units,proj:proj,bbox:bbox,w:width,h:height,units:units,label_size:label_size,l_size:l_size,intervals:intervals},function(s)
