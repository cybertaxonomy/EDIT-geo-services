...
eval("edit_"+data.id+".setVisibility(false)");
	...
	ajax_show=true;					
	$.ajax({url:'http://edit.africamuseum.be/edit_wp5/geo/point_pol/ppol_adaptat.php?polygon='+polygon+'&user='+userid+'&sld='+user_info,type:'get',user:userid,polygon:polygon,dataType:'json',timeout:120000,success:function(j)
						{						
	bbox=j['bbox'];
					sld_num_regs="http://edit.africamuseum.be/edit_wp5/geo/sld/analysis/"+j['sld_num_regs'];	
					num_regs_legend="http://193.190.223.46:8080/geoserver/wms/GetLegendGraphic?version=1.0.0&Format=image/png&WIDTH=25&HEIGHT=20&LAYER=topp:num_regs&SLD="+sld_num_regs;												
//alert(sld_num_regs);												
					sld_num_genus="http://edit.africamuseum.be/edit_wp5/geo/sld/analysis/"+j['sld_genera'];	
					num_genus_legend="http://193.190.223.46:8080/geoserver/wms/GetLegendGraphic?version=1.0.0&Format=image/png&WIDTH=25&HEIGHT=20&LAYER=topp:num_regs&SLD="+sld_num_genus;													
					sld_taxa_record="http://edit.africamuseum.be/edit_wp5/geo/sld/analysis/"+j['sld_taxa_rec'];							
					taxa_rec_legend="http://193.190.223.46:8080/geoserver/wms/GetLegendGraphic?version=1.0.0&Format=image/png&WIDTH=25&HEIGHT=20&LAYER=topp:taxa_record&SLD="+sld_taxa_record;	
