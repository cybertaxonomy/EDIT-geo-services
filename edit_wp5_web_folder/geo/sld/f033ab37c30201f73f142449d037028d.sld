          ...
          <PointSymbolizer>
            <Graphic>
              <Mark>
                ...
                <Fill>
                  <CssParameter name="fill">
                    <ogc:Literal>#ee6d11</ogc:Literal>
                  </CssParameter>
                  <CssParameter name="fill-opacity">0.9</CssParameter>
                </Fill>
                <Stroke>
          ...
          <PointSymbolizer>
            <Graphic>
              <Mark>
                ...
                <Fill>
                  <CssParameter name="fill">
                    <ogc:Literal>#11e4cf</ogc:Literal>
                  </CssParameter>
                  <CssParameter name="fill-opacity">0.9</CssParameter>
                </Fill>
                <Stroke>
          ...
          <PointSymbolizer>
            <Graphic>
              <Mark>
                ...
                <Fill>
                  <CssParameter name="fill">
                    <ogc:Literal>#101213</ogc:Literal>
                  </CssParameter>
                  <CssParameter name="fill-opacity">0.9</CssParameter>
                </Fill>
                <Stroke>
          ...
          <PointSymbolizer>
            <Graphic>
              <Mark>
                ...
                <Fill>
                  <CssParameter name="fill">
                    <ogc:Literal>#ee1748</ogc:Literal>
                  </CssParameter>
                  <CssParameter name="fill-opacity">0.9</CssParameter>
                </Fill>
                <Stroke>
          ...
          <PointSymbolizer>
            <Graphic>
              <Mark>
                ...
                <Fill>
                  <CssParameter name="fill">
                    <ogc:Literal>#bfd6ee</ogc:Literal>
                  </CssParameter>
                  <CssParameter name="fill-opacity">0.9</CssParameter>
                </Fill>
                <Stroke>
