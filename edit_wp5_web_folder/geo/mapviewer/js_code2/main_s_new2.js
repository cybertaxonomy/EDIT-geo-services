 ...
 // console.log("false");
	...
	//$("p[id='symbolize']").parent().children().attr('grup')
				...
				//console.log(p_color);
				   ...
				   {
				//alert(layer_name);
				//layer_name"=new OpenLayers.Layer.WMS.Untiled( l_name,'http://193.190.223.46:8080/geoserver/wms',{layers:''+l_name,sld:sld,transparent:'true'});
				//eval(layer_name+"=new OpenLayers.Layer.WMS.Untiled( "+l_name+",'http://193.190.223.46:8080/geoserver/wms',{layers:''"+l_name+"',sld:'"+sld+"',transparent:'true'});
