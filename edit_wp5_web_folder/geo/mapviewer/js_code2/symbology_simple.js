...
//        $('div[id*="_form"]').hide();
	...
	if ($.browser.msie==true) { s=0; } else {s=1;};				
						...
						$.ajax({url:'http://edit.africamuseum.be/edit_wp5/geo/mapviewer/test_xmls2.php',
								...
								var image=document.getElementById("legend");
								image.setAttribute("src",legend='http://193.190.223.46:8080/geoserver/wms/GetLegendGraphic?VERSION=1.0.0&FORMAT=image/png&WIDTH=25&HEIGHT=20&LAYER=topp:user_points&SLD='+data);
								}});
		}
	}
}
