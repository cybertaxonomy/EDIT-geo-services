...
$('#gbif_win').jqm({
    ...
    var jq='<div class="jqmdTL" style="background-size: 40%; z-index: 300;"><div class="jqmdTR"><div class="jqmdTC jqDrag">'+text+'</div><input type="image" class="jqmdX jqmClose"/></div></div><iframe id="gbif" name="gbif_iframe" class="jqDrag" marginWidth=0 marginHeight=0 src="http://edit.africamuseum.be/edit_wp5/geo/gbifs/index.html" frameBorder=0 width=380 height=300; background-color=#D7DBDF"></iframe>';
