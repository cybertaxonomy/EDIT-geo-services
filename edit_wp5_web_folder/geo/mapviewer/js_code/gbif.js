...
$('#gbif_win').jqm({
    ...
    var jq='<div class="jqmdTL" style="background-size: 40%; z-index: 300;"><div class="jqmdTR"><div class="jqmdTC jqDrag">'+text+'</div><input type="image" class="jqmdX jqmClose"/></div><iframe id="gbif" name="gbif_iframe" marginWidth=0 marginHeight=0 src="http://edit.br.fgov.be/edit_wp5/geo/gbifs/index.html" frameBorder=0 width=380 height=300; background-color=#D7DBDF"></iframe></div>';
...
if (msie)
{
 ...
 $('input.jqmdX').css('background','url(http://edit.br.fgov.be/edit_wp5/geo/mapviewer/img/close.gif)  no-repeat top left').css('width','14px');
}
else 
{
