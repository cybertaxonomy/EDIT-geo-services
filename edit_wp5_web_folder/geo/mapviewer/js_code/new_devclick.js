  		...
  		//ftheeten 11/02/2011
               ...
               /* map.events.register('click', map, function (e) {
                    ...
                    var params = {
                        ...
                        FEATURE_COUNT: 50,
                        Srs: 'EPSG:4326',
                        Layers:map.layers[0].name ,
                        Styles: '',
                        WIDTH: map.size.w,
                        HEIGHT: map.size.h,
                        format: "image/png"};
		var tmpURL= map.layers[0].getURL(map.layers[0].getExtent());
//alert(rootURL);		
		var rootURL=tmpURL.split("?");
		if(rootURL[0])
		{
alert(map.layers[0].name);			
alert(rootURL[0]);
		}
		                  
  OpenLayers.loadURL("http://edit.africamuseum.be:8080/geoserver/wms", params, this, setHTML, setHTML2);
...
*/
                    ...
                    var params_req = {
                        ...
                        QUERY_LAYERS: map.layers[0].params.LAYERS,
                        FEATURE_COUNT: 50,
                        Layers: 'topp:COD_RMCA_2M_BLS',
                        Styles: '',
                        Srs: 'EPSG:4326',
                        WIDTH: map.size.w,
                        HEIGHT: map.size.h,
                        format: "image/png"};
                    OpenLayers.loadURL("http://edit.africamuseum.be:8080/geoserver/wms", params_req, map, setHTML, setHTML);
                    OpenLayers.Event.stop(e);
                });
