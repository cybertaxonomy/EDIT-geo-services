...
alert(rootURL[0]);
  ...
  OpenLayers.loadURL("http://edit.br.fgov.be:8080/geoserver/wms", params, this, setHTML, setHTML2);
...
*/
                    ...
                    var params_req = {
                        ...
                        HEIGHT: map.size.h,
                        format: "image/png"};
                    OpenLayers.loadURL("http://edit.br.fgov.be:8080/geoserver/wms", params_req, map, setHTML, setHTML);
                    OpenLayers.Event.stop(e);
                });
