  $.get('../modules/print_module.php',function(data)
{
...
points_legend(edit_sp_points.params.SLD);
	...
	{
		$.get('../points_legend.php?sld='+sld,function(url_image)
										{
	...
	////				'font-size':'10',
	          ...
	          .children().hide();
				...
				{ 
							$.get('../test_scalebar2.php',{g_units:g_units,proj:proj,bbox:bbox,w:width,h:height,units:units,label_size:label_size,l_size:l_size,intervals:intervals},function(s)

					        {

					        d='../geo/images/scalebars/'+s;
			...
			//				$("#tif_form,#bits_form").slideUp()
				...
				var img=$("#choose_windrose_form option:selected").val();
					var windrose_path="../images/windroses/"+img;
			...
			$("#windrose").css('left',l);
					...
					$.get('../../v1/keymap.php?bbox='+bbox+"&dpi="+dpi+"&area="+area+"&zoom="+zoom+"&img=false",function(url_image)
										{
