...
var g_image=document.getElementById("genera_legend");
	g_image.setAttribute("src",legend='http://193.190.223.46:8080/geoserver/wms/GetLegendGraphic?VERSION=1.0.0&FORMAT=image/png&WIDTH=25&HEIGHT=20&LAYER=user_points&sld='+edit_points.params.SLD)+"date="+new Date();
$('div[id*="_form"]').hide();
$("#send").hide();
$("#informacio,#what_todo").hide();
												...
												//					console.log(g)
																...
																//	console.log(g_name)		
																	...
																	$.ajax({url:'http://edit.africamuseum.be/edit_wp5/geo/test_xmls2.php',
																			...
																			//		edit_points.redraw();
																			//g_legend.setAttribute("src",legend='http://193.190.223.46:8080/geoserver/wms/GetLegendGraphic?VERSION=1.0.0&FORMAT=image/png&WIDTH=25&HEIGHT=20&LAYER=topp:test_csvimportgispoints2&sld='+edit_points.params.SLD+'?date='+new Date());
																/*				Size=[];
...
/*
						...
						$.ajax({url:'http://edit.africamuseum.be/edit_wp5/geo/mapviewer/test_xmls2.php',
								...
								g_image.setAttribute("src",legend='http://193.190.223.46:8080/geoserver/wms/GetLegendGraphic?VERSION=1.0.0&FORMAT=image/png&WIDTH=25&HEIGHT=20&LAYER=topp:test_csvimportgispoints2&SLD='+data+'?date='+new Date());
								}});
*/								
		}
	}
