...
$("#boxes_tool").click(function()
{
					...
					{
						alert("Only with latitude/longitude you can use these tools");return false;
					}
					else
					{
...

{
					if (map.getProjection() !="EPSG:4326")
					{
						alert("Only with latitude/longitude you can visualize GBIF data");return false;
					}
					else
					{
	var ajax_show=true;
	...
	$("#run_analysis a").click(function()
				{
					if (map.getProjection() !="EPSG:4326")
					{
						alert("Only with latitude/longitude you can perform this analysis");return false;
					}
					else
					{
...
//				$("input[id='"+s_layer+"']").trigger('click');//remove layer from edit_nature or edit_admin
		...
		var path="http://193.190.223.53:8080/geoserver/wms/GetLegendGraphic?VERSION=1.0.0&FORMAT=image/png";
