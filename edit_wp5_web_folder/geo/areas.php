...
$random2=V1_IMG."/".md5($_SERVER["REQUEST_URI"] ).".png";
...
//$random = (rand()%300).".sld";
//$leg_path_towrite=DIR_PLATFORM."/synthesys/www/fitxers/sld/$random";
//$leg_path_towrite=DIR_PLATFORM."/synthesys/www/v1/sld/$random";
$leg_path_towrite=V1_SLD."/$random";
...
$path_towrite=V1_SLD."/".$feature."_".$random;
//echo $path_towrite;
...
$url.="&format=image/png&bbox=".$bbox."&WIDTH=".$width."&HEIGHT=".$height."&SLD=".URL_SITE."/synthesys/www/v1/sld/".$feature."_".$random;
...
$t_position='0x0+10+'.$h;
//$c="convert -pointsize $f_size -stroke $f_color $antialias -font DIR_PLATFORM.'/synthesys/Data_Directory/Fonts/$font' -annotate $t_position '$mc' $random2 $random2";
$c="convert -pointsize $f_size -stroke $f_color $antialias -font '".FONT_DIRECTORY."' -annotate $t_position '$mc' $random2 $random2";

shell_exec($c);
}
header("Content-Type: image/png");	
//readfile($random2);
//$random3 =DIR_PLATFORM."/synthesys/www/v1/img/".(rand()%300).".png";
$random3=V1_IMG."/".(rand()%300).".png";
